                      ...
                      <div className="mt-2 space-y-1.5">
                        <div className="flex items-center gap-3 flex-wrap">
                          <span className={cn(
                            ...
                            r.winRate >= 0.55 ? "text-profit" : "text-loss"
                          )}>
                ...
                <tbody>
                  {runs.map((r) => (
                    <tr key={r.id} className="border-b border-border/50 last:border-0">
                      ...
                      <td className={cn("py-2 text-right font-mono font-medium", r.winRate >= 0.55 ? "text-profit" : "text-loss")}>
                        {(r.winRate * 100).toFixed(1)}%
                      </td>
                      <td className={cn("py-2 text-right font-mono", r.edgePct >= 0.5 ? "text-profit" : "text-loss")}>
                        {r.edgePct.toFixed(1)}%
                      </td>
