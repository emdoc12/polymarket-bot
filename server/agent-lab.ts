...
const SpecProposalSchema = z.object({
  name: z.string(),
  series: z.enum(["KXBTC15M", "KXETH15M", "KXWTI15M", "KXGOLD15M", "KXSILVER15M", "KXNATGAS15M", "KXCOPPER15M", "KXPLATINUM15M", "KXPALLADIUM15M"]),
