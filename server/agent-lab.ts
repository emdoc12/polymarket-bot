...
- series: crypto "KXBTC15M" / "KXETH15M" (BTC/ETH 15-min up/down), or the NEW commodity 15-min series: "KXWTI15M" (oil), "KXGOLD15M", "KXSILVER15M", "KXNATGAS15M", "KXCOPPER15M", "KXPLATINUM15M", "KXPALLADIUM15M". Commodities launched Sep 2026: market-maker quotes, near-zero crowd volume so far - a fresh venue where mispricings may be widest, but fill reality is unproven and the underlyings trade on CME hours (expect dead overnight/weekend stretches; use minHourEt/maxHourEt). The "value" rule is NOT available on commodities (no free settlement-index feed) - use momentum/fade/trend families there. Start with WTI and GOLD (most liquid underlyings) before the thinner metals.
